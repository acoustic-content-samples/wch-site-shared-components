...
import { CarouselDynamicListLayoutComponent } from './carouselDynamicListLayout';
...
@NgModule({
    ...
    */
    ...
    declarations: [CarouselDynamicListLayoutComponent],
    exports: [CarouselDynamicListLayoutComponent],
    entryComponents: [CarouselDynamicListLayoutComponent]
})
export class CarouselDynamicListModule {
}