...
import { CarouselListLayoutComponent } from './carouselListLayout';
...
@NgModule({
    ...
    */
    ...
    declarations: [CarouselListLayoutComponent],
    exports: [CarouselListLayoutComponent],
    entryComponents: [CarouselListLayoutComponent]
})
