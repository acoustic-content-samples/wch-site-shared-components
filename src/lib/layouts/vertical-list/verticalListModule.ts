...
import { VerticalListLayoutComponent } from './verticalListLayout';
...
@NgModule({
    ...
    */
    ...
    declarations: [VerticalListLayoutComponent],
    exports: [VerticalListLayoutComponent],
    entryComponents: [VerticalListLayoutComponent]
})
