...
import { GalleryDynamicListLayoutComponent } from './galleryDynamicListLayout';
...
@NgModule({
    ...
    */
    ...
    declarations: [GalleryDynamicListLayoutComponent],
    exports: [GalleryDynamicListLayoutComponent],
    entryComponents: [GalleryDynamicListLayoutComponent]
})
export class GalleryDynamicListModule {
}