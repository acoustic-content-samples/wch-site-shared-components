...
import { VerticalDynamicListLayoutComponent } from './verticalDynamicListLayout';
...
@NgModule({
    ...
    */
    ...
    declarations: [VerticalDynamicListLayoutComponent],
    exports: [VerticalDynamicListLayoutComponent],
    entryComponents: [VerticalDynamicListLayoutComponent]
})
export class VerticalDynamicListModule {
}